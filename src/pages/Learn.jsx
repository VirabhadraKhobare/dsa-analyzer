...
const Learn = () => {
  ...
  const tutorials = [
    ...
    },
    {
      ...
      rating: 4.9,
      students: 980,
      topics: ['Divide & Conquer', 'Sorted Arrays', 'Log Complexity'],
      complexity: { time: 'O(log n)', space: 'O(1)' }
    },
    {
      id: 3,
      title: 'Linked List Fundamentals',
      description: 'Understand linked lists, pointers, and memory management.',
      category: 'linked-lists',
      difficulty: 'beginner',
      duration: '20 min',
      rating: 4.7,
      students: 1100,
      topics: ['Nodes', 'Pointers', 'Insertion', 'Traversal'],
      complexity: { time: 'O(n)', space: 'O(n)' }
    },
    {
      id: 4,
      title: 'Stack Data Structure',
      description: 'Learn stack operations, applications, and implementation techniques.',
    ...
    },
    {
      ...
      rating: 4.7,
      students: 689,
      topics: ['Bubble Sort', 'Quick Sort', 'Merge Sort', 'Time Analysis'],
      complexity: { time: 'O(n log n)', space: 'O(log n)' }
    },
    {
      id: 8,
      title: 'Queue Operations & Applications',
      description: 'Master queue data structure and its real-world applications.',
      category: 'stacks-queues',
      difficulty: 'beginner',
      duration: '22 min',
      rating: 4.5,
  ...
  const quickFacts = [
    {
      ...
      content: 'Understanding Big O notation helps you analyze algorithm efficiency',
      icon: <Clock className="h-6 w-6 text-blue-600" />
    },
    {
      title: 'Space Complexity',
      content: 'Memory usage is crucial for large-scale applications',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-4 lg:grid-cols-8 gap-4 mb-8">
          {categories.map((category) => (
            ...
            >
              <div className={`mx-auto mb-2 ${selectedCategory === category.id ? 'text-blue-600' : 'text-gray-500'}`}>
                {category.icon}
              </div>
          ...
          {filteredTutorials.map((tutorial) => (
            <div key={tutorial.id} className="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow">
              <div className="p-6">
                ...
                <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md font-medium transition-colors flex items-center justify-center">
        ...
        <div className="mt-16 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-8">
